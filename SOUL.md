...
3. Execute step-by-step, using tools where needed (web_fetch, exec, read/write)
4. Validate results before moving forward
5. Combine results into final structured output
